...
class RegisterViewController: UIViewController {
    ...
    private let headerView = HeaderViewLogin(title: "Create your account", subTitle: "Please fill Username, Fullname, No.KTP & Password to register your app")
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            self.fullnameField.topAnchor.constraint(equalTo: usernameField.bottomAnchor, constant: 12),
            self.fullnameField.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant: 20),
            ...
            self.noKTPField.topAnchor.constraint(equalTo: fullnameField.bottomAnchor, constant: 12),
            ...
            self.registerButton.topAnchor.constraint(equalTo: repeatPasswordField.bottomAnchor, constant: 100),
            ...
            self.loginButton.topAnchor.constraint(equalTo: registerButton.bottomAnchor, constant: 6),
